...
insert_figure(as_figure(car_panel, label = 'car_panel', w = 180, h = 120, unit = 'mm'))
...
report_exp <- list(car_number = mdexpr(nrow(mtcars)),
...
report_tables <- list(cars = as_mdtable(mtcars,
                                        label = 'mt_cars',
                                        ref_name = 'mt_cars',
                                        caption = 'Car data'),
...
report_plots <- list(fig1 = as_figure(car_dist,
                                      w = 90,
                                      h = 60,
                                      label = 'figure_1',
                                      ref_name = 'fig_dist',
...
insert(report_plots$panel, html = TRUE)
